...
@Autonomous
public class RadicalAuto2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (counter == 0) {
                ...
                if (jewelDetector.getLastOrder() == JewelDetector.JewelOrder.BLUE_RED) {
                ...
                } else if (jewelDetector.getLastOrder() == JewelDetector.JewelOrder.RED_BLUE) {
                    Servo5.setPosition(1);
                    Servo6.setPosition(0);
                    sleep(500);
                    Servo6.setPosition(0.313);
            ...
            while (counter == 2) {
                ...
                RightBackDrive.setTargetPosition(oneRev);
                LeftBackDrive.setTargetPosition(oneRev);
                int curr = RightFrontDrive.getCurrentPosition();
                telemetry.addLine("ONE");
                while (Math.abs(curr) <= (oneRev * 2)) {
            ...
            while (counter == 3) {
                ...
                int curr = RightFrontDrive.getCurrentPosition();
                telemetry.addLine("ONE");
                while (Math.abs(curr) <= (0.5*oneRev)) {
                    RightFrontDrive.setPower(.5);
                    LeftFrontDrive.setPower(.5);
                    RightBackDrive.setPower(.5);
                    LeftBackDrive.setPower(.5);
                    curr = RightFrontDrive.getCurrentPosition();
                    telemetry.addLine("TWO");
