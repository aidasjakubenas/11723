...
@Autonomous
public class RadicalAutoRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            while (counter == 2) {
                ...
                RightBackDrive.setTargetPosition(oneRev);
                LeftBackDrive.setTargetPosition(oneRev);
                int curr = LeftBackDrive.getCurrentPosition();
                telemetry.addLine("ONE");
                while (curr <= (oneRev * 1.5)) {
                    ...
                    curr = LeftBackDrive.getCurrentPosition();
                    telemetry.addLine("TWO");
            ...
            while (counter == 3) {
                ...
                RightBackDrive.setTargetPosition(oneRev);
                LeftBackDrive.setTargetPosition(oneRev);
                int curr = LeftFrontDrive.getCurrentPosition();
                telemetry.addLine("ONE");
                while (curr <= (oneRev * .5)) {
